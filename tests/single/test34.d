...
/+ #define X defined(4) +/
enum X = q{imported!q{test34}.defined(4)};
__gshared int i2 = mixin(X);
/+ #define f(x) defined(x) +/
extern(D) alias f = function string(string x)
{
    return mixin(interpolateMixin(q{imported!q{test34}.defined($(x))}));
};
__gshared int i3 = mixin(f(q{5}));
/+ #define Y f(6) +/
enum Y = q{mixin(imported!q{test34}.f(q{6}))};
__gshared int i4 = mixin(Y);
/+ #define g() X +/
extern(D) alias g = function string()
{
    return mixin(interpolateMixin(q{mixin(imported!q{test34}.X)}));
};
