...
{
    return /*commente1*/ mixin(interpolateMixin(q{ $(imported!q{testcomments6}.f(q{/*commentc3*/7/*commentc4*/},q{/*commentc5*/b/*commentc6*/},q{/*commentc7*/9/*commentc8*/}))/+ g/*commente2*/(/*commente3*/f/*commente4*/(/*commente5*/,/*commente6*/,/*commente7*/)/*commente8*/) +/}));/*commente9*/
};
