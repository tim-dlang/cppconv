...
struct S
{
	...
	uint test2() const nothrow
	{
    	return (bitfieldData_test2 >> 0) & 0x1;
	}
	uint test2(uint value) nothrow
	{
	...
	static if (defined!"DEF")
	{
	uint test3() const nothrow
	{
    	return (bitfieldData_test2 >> 1) & 0x3;
	}
	uint test3(uint value) nothrow
	{
	...
	static if (defined!"DEF")
	{
	uint test5() const nothrow
	{
    	return (bitfieldData_test2 >> 3) & 0x1;
	}
	uint test5(uint value) nothrow
	{
