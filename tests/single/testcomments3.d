...
{
    return /*comment a1*/ mixin(interpolateMixin(q{g/*comment a2*/(/*comment a3*/$(x)/*comment a4*/,/*comment a5*/$(y)/*comment a6*/)}));/*comment a7*/
};
...
{
    return /*comment b1*/ mixin(interpolateMixin(q{ mixin(f1/*comment b2*/(/*comment b3*/q{$(x)}/*comment b4*/,/*comment b5*/q{$(y)}/*comment b6*/))}));/*comment b7*/
};
...
enum X2 = /*comment d1*/q{ mixin(f1/*comment d2*/(/*comment d3*/q{2}/*comment d4*/,/*comment d5*/q{3}/*comment d6*/))};/*comment d7*/
/+ #define X3 /*comment e1*/f2/*comment e2*/(/*comment e3*/4/*comment e4*/,/*comment e5*/5/*comment e6*/) +//*comment e7*/
enum X3 = /*comment e1*/q{ mixin(f2/*comment e2*/(/*comment e3*/q{4}/*comment e4*/,/*comment e5*/q{5}/*comment e6*/))};/*comment e7*/
