...
#lockdefine QT_DECLARE_NATIVE_INTERFACE

#define QT_FEATURE_cxx17_filesystem -1
#lockdefine QT_FEATURE_cxx17_filesystem

#undef QT_IMPLICIT_QCHAR_CONSTRUCTION
#undef QT_IMPLICIT_QFILEINFO_CONSTRUCTION
